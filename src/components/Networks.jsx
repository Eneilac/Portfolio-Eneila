...
const Networks = () => {
    ...
    return (
        <div className="sm:fixed md:fixed lg:fixed bottom-4 right-8 z-50 mb-4 sm:mb-0 md:mb-0 lg:mb-0">
            <div className="flex gap-5 justify-center">
                <a
                    target="_blank"
                    href="https://www.linkedin.com/in/eduardo-neila-calzado-9b7429208/"
                ...
                <a href="https://wa.me/+34605310957" target="_blank" className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 shadow-md group transition-all duration-300">
                ...
                <div className="group relative flex">
                    <a target="_blank" href="https://github.com/Eneilac">
                        <svg strokeLinejoin="round"
                            strokeLinecap="round"
                            strokeWidth="2"
                            stroke="currentColor"
                            fill="none" viewBox="0 0 24 24"
                            className="w-8 hover:scale-125 duration-200 hover:stroke-blue-500 cursor-pointer">
